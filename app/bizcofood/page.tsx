...
const FEATURES = [
  ...
  },
  {
    ...
    description: "ثبت فاکتور و مدیریت صندوق؛ پیگیری بدهی و طلب مشتریان و تأمین‌کنندگان.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" aria-hidden="true" className="h-9 w-9">
  ...
  },
  {
    ...
    description: "مدیریت پرسنل و برنامه‌ریزی شیفت‌ها؛ باشگاه مشتریان وفادار برای افزایش فروش.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" aria-hidden="true" className="h-9 w-9">
